...
```{r}
#  fig.cap="Estimates for the average causal effect of timeouts on the scoring run in three minutes post-timeout"
...
kable(tibble('Method' = method, 
             ...
             caption="Estimates for the average causal effect of timeouts on the scoring run in three minutes post-timeout") %>% kable_styling(position = "center")
```
